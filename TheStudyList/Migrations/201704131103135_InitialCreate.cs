namespace TheStudyList.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        FirstStudiedDate = c.DateTime(nullable: false),
                        Notebook = c.String(),
                        Topic = c.String(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Reviews", "Note_Id", "dbo.Notes");
            DropForeignKey("dbo.Resources", "Note_Id", "dbo.Notes");
            DropForeignKey("dbo.Resources", "Book_Id", "dbo.Books");
            ...
            DropIndex("dbo.Reviews", new[] { "Note_Id" });
            DropIndex("dbo.Notes", new[] { "User_Id" });
            DropIndex("dbo.Resources", new[] { "Note_Id" });
            DropIndex("dbo.Resources", new[] { "Book_Id" });
